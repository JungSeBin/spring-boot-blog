...
import com.seb.blog.github.GithubClient;
import com.seb.blog.github.GithubUser;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public AuthoritiesExtractor authoritiesExtractor() {
        return map -> {
            ...
            if ("JungSeBin".contains(username)) {
    ...
    @Bean
    public PrincipalExtractor principalExtractor(GithubClient githubClient, UserDao userDao) {
        return map -> {
            String githubLogin = (String) map.get("login");
            User loginUser = userDao.findByGithub(githubLogin);
            if (loginUser == null) {
